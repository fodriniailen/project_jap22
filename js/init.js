...
document.addEventListener("DOMContentLoaded", (e) => {
  ...
  let htmlContentToAppend = ""; {
    htmlContentToAppend = ` 
  <div class="dropdown">
  <a href="index.html" class="drop-user" id="dropdown">Iniciar Sesión ▾</a>
  <div class="dropdown-content">
  <a href="cart.html">Mi carrito</a>
  <a href="my-profile.html" id="my-profile" class="disabled">Mi perfil</a>
  <div id="cerrar-sesion"  onclick="borrarID()"><a href="index.html" class="display-none">Cerrar sesión</a>
  </div>
  </div>
